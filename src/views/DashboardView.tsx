        ...
        <div className="p-8 h-full overflow-y-auto custom-scrollbar animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <MetricCard
                    ...
                    max={100}
                    unit="°C"
                    color={system.gpuTemp > 80 ? 'rose' : 'emerald'}
                />
                ...
                <div className="bg-zinc-900/30 border border-white/5 rounded-2xl p-6 flex flex-col relative overflow-hidden backdrop-blur-md">
                    ...
                    <div className="grid grid-cols-1 gap-3 relative z-10">
                        <button
                            ...
                            className="flex items-center gap-3 p-3 rounded-xl bg-zinc-800/30 hover:bg-zinc-800 border border-zinc-700/30 hover:border-indigo-500/30 transition-all group text-left"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center gap-3 p-3 rounded-xl bg-zinc-800/30 hover:bg-zinc-800 border border-zinc-700/30 hover:border-emerald-500/30 transition-all group text-left"
                        >
                ...
                <div className="lg:col-span-2 bg-black border border-white/10 rounded-2xl flex flex-col shadow-inner overflow-hidden">
                    ...
                    <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-1 font-mono text-[11px]">
                        {system.logs.map((log) => (
                            <div
                                key={log.id}
                                className="flex gap-3 hover:bg-white/5 p-0.5 rounded px-2 transition-colors opacity-80 hover:opacity-100"
                            >
                        ...
                        <div ref={logEndRef} className="animate-pulse text-indigo-500 pl-2">
                            _
                        </div>
                    </div>
                </div>
